...
# 1. создаём список из случайных чисел
numbers = []
for i in range(10):          # 10 случайных чисел, можно изменить количество
    numbers.append(randint(0, 100))

print("Список чисел:", numbers)

# 2. суммируем только чётные значения
even_sum = 0
for x in numbers:
    if x % 2 == 0:           # проверка на чётность
        even_sum += x

# 3. выводим сумму в консоль
